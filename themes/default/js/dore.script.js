  ...
  function init() {
    ...
    if ($().select2) {
      ...
      $(".select2-status").select2({
        theme: "bootstrap",
        dir: direction,
        placeholder: "Select Status / None",
        maximumSelectionSize: 6,
        containerCssClass: ":all:"
      });
      $(".select2-category-type").select2({
        theme: "bootstrap",
        dir: direction,
        placeholder: "Select Category Type / None",
        maximumSelectionSize: 6,
        containerCssClass: ":all:"
      });
      ...
      $(".select2-parent").select2({
        theme: "bootstrap",
        dir: direction,
        placeholder: "None / Select Parent",
        maximumSelectionSize: 6,
        containerCssClass: ":all:"
      });
    ...
    if ($().datepicker) {
      ...
      $("input.datepickertime").datepicker({
        autoclose: true,
        rtl: isRtl,
    ...
    if (typeof ClassicEditor !== "undefined") {
      ...
      ClassicEditor.create(document.querySelector("#ckEditorClassic2")).catch(function (error) { });
    }
